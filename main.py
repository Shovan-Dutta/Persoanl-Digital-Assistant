...
label3 = Label(creditsframe,text="by,",font="Courier 10",pady=10,fg = "white",background=bcolor)
label3.grid(column=0, row = 0)
label4 = Label(creditsframe,text="Sougata, Rohita, Som, Ritu, Shovan",font="Courier 10",fg = "white",pady=10,background=bcolor)
